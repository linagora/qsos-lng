...
phrases. Tu peux utiliser du markdown. Voici le README du logiciel en question.
`
...
sentences. Markdown is allowed. Here is the README of the software in question.
`
