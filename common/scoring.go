...
// ComputeScoreFloat calculates a 1-5 score based on float value and thresholds
func ComputeScoreFloat(nb float64, thresholds [4]float64, direction Direction) int64 {
	scale := [5]int64{1, 2, 3, 4, 5}
	if direction == SmallerIsBetter {
		scale = [5]int64{5, 4, 3, 2, 1}
	}
